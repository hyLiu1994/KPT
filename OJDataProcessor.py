...
class OJDataProcessor(object):
    ...
    def loadSubmitRecordOfTimeWindows(self, timeLC, timedivid):
        ...
        tmpstr=self.TmpDir +self.DataName+"_"+tmptimeLC+"_"+tmptimedivid+'_KPT_input.csv'
        ...
        file2 = open(self.TmpDir +self.DataName+"_"+str(timeLC)+"_"+str(timedivid)+'_KPT_input.csv', 'w', encoding='utf-8')
        a=str(timeLC)
        print(a)
        for line in file:
            line = line.split(',')
